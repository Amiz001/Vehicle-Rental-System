...
<body>
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="branches.php" style="background-color: #fca311;"><i class="fa-solid fa-code-branch"></i>Branches</a>
    ...
    <div class="main-content">
        ...
        <div class="table-container">
            <a href="add_branch.php"><button id="add-btn">Add Branch</button></a><br>
        <?php
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                echo "<tr>
                        ...
                        <td>
                            <a href='edit_branch.php?id={$row['branch_id']}'><button id='edit-btn'>Edit</button></a> | 
                            <a href='delete_branch.php?id={$row['branch_id']}'><button id='delete-btn'>Delete</button></a>
                        </td>
                    </tr>";
            }
            echo "</table>";
